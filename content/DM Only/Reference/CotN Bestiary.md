...
## Aboleth Spawn
*Medium Aberration, typicallylawful evil*
...
### Legendary Actions
*Legendary Action Uses: 3. Immediately after another creature's turn, The alyxian aboleth can expend a use to take one of the following actions. The alyxian aboleth regains all expended uses at the start of each of its turns.*
...
1/day each: *lesser restoration*, *remove curse*, *water breathing*  
...
### Legendary Actions
*Legendary Action Uses: 3. Immediately after another creature's turn, Alyxian can expend a use to take one of the following actions. Alyxian regains all expended uses at the start of each of their turns.*
...
## Aradrine the Owl
*Medium Humanoid (Goliath, Sorcerer), typicallylawful neutral*
...
- **Skills** Arcana +8, Athletics +4, Deception +11, History +5, Perception +6
...
***Alien Mind.*** If a creature tries to read Aradrine's thoughts or deals psychic damage to Aradrine, that creature must succeed on a DC 16 Intelligence saving throw or be stunned until the start of its next turn.  

***Magic Resistance.*** Aradrine has advantage on saving throws against spells and other magical effects.  

***Powerful Build.*** Aradrine counts as one size larger when determining their carrying capacity and the weight they can push, drag, or lift.  
...
***Possession (Recharge 6).*** One humanoid that Celeste can see within 5 feet of it must succeed on a DC 13 Charisma saving throw or be possessed by Celeste; Celeste then disappears, and the target is incapacitated and loses control of its body. Celeste now controls the body but doesn't deprive the target of awareness. Celeste can't be targeted by any attack, spell, or other effect, except ones that turn undead, and it retains its alignment, Intelligence, Wisdom, Charisma, and immunity to being charmed and frightened. It otherwise uses the possessed target's statistics, but doesn't gain access to the target's knowledge, class features, or proficiencies.  
The possession lasts until the body drops to 0 hit points, Celeste ends it as a bonus action, or Celeste is turned or forced out by an effect like the *dispel evil and good* spell. When the possession ends, Celeste reappears in an unoccupied space within 5 feet of the body. The target is immune to this ghost's Possession for 24 hours after succeeding on the saving throw or after the possession ends.
...
## Death Embrace
*Huge Aberration, typicallychaotic evil*
...
***Powerful Build.*** Foghome counts as one size larger when determining their carrying capacity and the weight they can push, drag, or lift.  

***Speech of Beast and Leaf.*** Foghome can communicate in a limited way with Beasts and Plants. These creatures understand the meaning of Foghome's words, though Foghome has no ability to understand their languages. In addition, Foghome has advantage on Charisma checks they make to influence a Beast or Plant.  
...
1/day each: *mage armor*, *major image*, *phantasmal force*  
...
## Gryz Alakritos
*Small Humanoid (Goblin, Wizard), neutral good*
...
***Nimble Escape.*** Gryz can take the Disengage or Hide action as a bonus action on each of its turns.  
...
2/day each: *detect thoughts*, *identify* (as an action), *scrying* (as an action)
...
***Assassinate.*** During its first turn, Koris has advantage on attack rolls against any creature that hasn't taken a turn. Any hit Koris scores against a surprised creature is a critical hit.  
...
***Innate Spellcasting.*** Koris's innate spellcasting ability is Charisma (spell save DC 11). Koris can innately cast the following spells, requiring no material components:  

At will: *thaumaturgy*  
1/day each: *darkness*, *hellish rebuke*  


***Sneak Attack (1/Turn).*** Koris deals an extra 14 (4d6) damage when it hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Koris that isn't incapacitated and Koris doesn't have disadvantage on the attack roll.  
...
***Possession (Recharge 6).*** One humanoid that Marisa can see within 5 feet of it must succeed on a DC 13 Charisma saving throw or be possessed by Marisa; Marisa then disappears, and the target is incapacitated and loses control of its body. Marisa now controls the body but doesn't deprive the target of awareness. Marisa can't be targeted by any attack, spell, or other effect, except ones that turn undead, and it retains its alignment, Intelligence, Wisdom, Charisma, and immunity to being charmed and frightened. It otherwise uses the possessed target's statistics, but doesn't gain access to the target's knowledge, class features, or proficiencies.  
The possession lasts until the body drops to 0 hit points, Marisa ends it as a bonus action, or Marisa is turned or forced out by an effect like the *dispel evil and good* spell. When the possession ends, Marisa reappears in an unoccupied space within 5 feet of the body. The target is immune to this ghost's Possession for 24 hours after succeeding on the saving throw or after the possession ends.
...
***Possession (Recharge 6).*** One humanoid that Meri can see within 5 feet of it must succeed on a DC 13 Charisma saving throw or be possessed by Meri; Meri then disappears, and the target is incapacitated and loses control of its body. Meri now controls the body but doesn't deprive the target of awareness. Meri can't be targeted by any attack, spell, or other effect, except ones that turn undead, and it retains its alignment, Intelligence, Wisdom, Charisma, and immunity to being charmed and frightened. It otherwise uses the possessed target's statistics, but doesn't gain access to the target's knowledge, class features, or proficiencies.  
The possession lasts until the body drops to 0 hit points, Meri ends it as a bonus action, or Meri is turned or forced out by an effect like the *dispel evil and good* spell. When the possession ends, Meri reappears in an unoccupied space within 5 feet of the body. The target is immune to this ghost's Possession for 24 hours after succeeding on the saving throw or after the possession ends.
...
## Occult Silvertongue
*Small or Medium Humanoid (Sorcerer), typicallylawful evil*
...
***Angelic Weapons.*** Perigee's weapon attacks are magical. When Perigee hits with any weapon, the weapon deals an extra 4d8 radiant damage (included in the attack).  
...
***Healing Touch (3/Day).*** Perigee touches another creature. The target magically regains 20 (4d8 + 2) hit points and is freed from any curse, disease, poison, blindness, or deafness.  
...
***Innate Spellcasting.*** Prolix's innate spellcasting ability is Charisma (spell save DC 10). Prolix can innately cast the following spells, requiring no material components:  
...
## Scribble
*Medium Humanoid (Kenku, Wizard), any alignment*
...
***Mimicry.*** Scribble can mimic any sounds it has heard, including voices. A creature that hears the sounds can tell they are imitations with a successful DC 14 Wisdom (Insight) check.  

### Actions
***Arcane Shock.*** *Melee  or Ranged Spell Attack:*  +5 to hit, reach 5 ft. or range 30 ft., one target. *Hit:* 14 (2d10 + 3) lightning damage. If the target is a creature, it can't take reactions until the start of its next turn.  

***Spellcasting.*** Scribble casts one of the following spells, using Intelligence as the spellcasting ability:  

At will: *dancing lights*, *mage hand*  
1/day each: *comprehend languages*, *identify* (as an action), *mage armor*  

### Reactions
***Glyph of Shielding.*** Scribble adds 2 to its AC against one attack that would hit it. To do so, Scribble must be able to see the attacker and have a free hand.
...
### Bonus Actions
***Swallow.*** *Melee Weapon Attack:*  +9 to hit, reach 5 ft., one Medium or smaller creature the bloodfin is grappling. *Hit:* The bloodfin swallows the target. The swallowed creature is no longer grappled but is blinded and restrained. It has total cover against attacks and other effects outside the bloodfin, it takes 14 (4d6) necrotic damage at the start of each of its turns, and the bloodfin regains hit points equal to the necrotic damage dealt. A bloodfin can have only one creature swallowed at a time.  
...
***Powerful Build.*** Xot counts as one size larger when determining their carrying capacity and the weight they can push, drag, or lift.  
